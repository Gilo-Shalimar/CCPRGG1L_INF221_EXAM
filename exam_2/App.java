...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int lastdigit = toLastDigit(studentNumber);
        System.out.print("Last six digits: " + lastdigit );
        ...
        System.out.print("Full name length: " + fullname.length() );
       ...
       {         // If BSCS
        ...
        if (studentEmailAddress.contains("gilo"))
        {
            System.out.print("Valid");
        }
        else
